...
# Evaluate on target
python adda.py -t=True -c=3 -ibcknd=0 -s="results7vaihinghen/source_weights_"$source".h5" -sds $target 

# Adversrial train
python adda.py -f -c=3 -ibcknd=0 -s="results7vaihinghen/source_weights_"$source".h5" -sds $source -tds=$target -advval=1 
